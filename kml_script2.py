...
#input_parameter = '\\aurecon.info\shares\AUMKY\Projects\GIS\Projects\KNP\Data\Received\Download\Data.NT\20190930\nt-government-controlled-road-maps\nt-government-controlled-road-maps.kmz'
input_parameter = r"C:\Users\Michael.Fleming\Aurecon Group\522898 - Banana Range Wind Farm Development Owners Engineer - 07_GIS\Data\Transfer\In\Internal\AndrewMacGillivray\20230817\2023-08-17 Infrastructure on Wulli Wulli land.kmz"
...
#in stand-alone script use arcpy.SpatialReference('desired Coord Sys name')
coord_sys = arcpy.SpatialReference(7856)
...
keep_fields = ['OID','FolderPath', 'Shape', 'SHAPE', 'PopupInfo', 'Shape_Length', 'Shape_Area', 'SHAPE_Length', 'SHAPE_Area']
...
#now we update the values
   names_array= [x.replace(' ','_') for x in names_array]
   names_array= [x.replace('.','_') for x in names_array]
   
   #names_array.remove("OID")
